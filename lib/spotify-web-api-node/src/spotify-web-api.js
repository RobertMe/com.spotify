...
SpotifyWebApi.prototype = {
  ...
  getMyRecentlyPlayedTracks: function(options, callback) {
	 ...
	 *          otherwise an error. Not returned if a callback is given.
	 */
	getMyRecentlyPlayedTracks: function(callback) {
		var request = WebApiRequest.builder()
   ...
   * @param {string|string[]} [options.device_id] The id(s) of the target device(s), if not set this method is performed on the currently active device.
  ...
  transferMyPlayback: function(options, callback) {
    var request = WebApiRequest.builder()
      ...
      .withHeaders({ 'Content-Type' : 'application/json' })
      .withBodyParameters({
        'device_ids': (options ||{}).device_ids ? [].concat(options.device_ids) : undefined,
   ...
   * @param {number|string} [offset] Offset is a number or spotify track uri where playback should start.
	 * @param {requestCallback} [callback] Optional callback method to be called instead of the promise.
   ...
   * @param {string} [options.device_id] The id of the target device, if not set this method is performed on the currently active device.
	 ...
	 *          otherwise an error. Not returned if a callback is given.
	 */
	skipMyPlaybackNext: function(options, callback) {
		var request = WebApiRequest.builder()
	...
	/**
	 * Seek to position in Currently playing track of User's Playback
	 * @param {Object} options Options.
	 * @param {string} [options.device_id] The id of the target device, if not set this method is performed on the currently active device.
